...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private boolean launchSpecialActions(String value) {
        ...
        if (musicPlaybackEnabled) {
            switch (value) {
                case com.aicp.device.AppSelectListPreference.MUSIC_PLAY_ENTRY:
                    mGestureWakeLock.acquire(GESTURE_WAKELOCK_DURATION);
                    AicpVibe.performHapticFeedbackLw(HapticFeedbackConstants.LONG_PRESS, false, mContext,GESTURE_HAPTIC_SETTINGS_VARIABLE_NAME,GESTURE_HAPTIC_DURATION);
                    dispatchMediaKeyWithWakeLockToAudioService(KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE);
                    return true;
                case com.aicp.device.AppSelectListPreference.MUSIC_NEXT_ENTRY:
                    if (isMusicActive()) {
                        mGestureWakeLock.acquire(GESTURE_WAKELOCK_DURATION);
                        AicpVibe.performHapticFeedbackLw(HapticFeedbackConstants.LONG_PRESS, false, mContext,GESTURE_HAPTIC_SETTINGS_VARIABLE_NAME,GESTURE_HAPTIC_DURATION);
                    ...
                    return true;
                case com.aicp.device.AppSelectListPreference.MUSIC_PREV_ENTRY:
                    if (isMusicActive()) {
                        mGestureWakeLock.acquire(GESTURE_WAKELOCK_DURATION);
                        AicpVibe.performHapticFeedbackLw(HapticFeedbackConstants.LONG_PRESS, false, mContext,GESTURE_HAPTIC_SETTINGS_VARIABLE_NAME,GESTURE_HAPTIC_DURATION);
    ...
    private String getGestureValueForScanCode(int scanCode) {
        ...
        switch(scanCode) {
            case GESTURE_II_SCANCODE:
                return com.aicp.device.AppSelectListPreference.MUSIC_PLAY_ENTRY;
            ...
            case GESTURE_LEFT_V_SCANCODE:
                return com.aicp.device.AppSelectListPreference.MUSIC_PREV_ENTRY;
            case GESTURE_RIGHT_V_SCANCODE:
                return com.aicp.device.AppSelectListPreference.MUSIC_NEXT_ENTRY;
